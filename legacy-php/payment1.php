                        ...
                        <form method="post" action="#" id="contact-form" class="default-form">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
									...
									<button onclick="window.location.href='https://www.payvangservices.com/paynow.php';" class="btn theme-btn-1" type="submit" name="submit-form">Fetch Bill</button>-->
									<a href="paynow.php" class="btn theme-btn-1">Fetch Bill</a>
                                </div>
                            </div>
                        </form>
                    </div>
