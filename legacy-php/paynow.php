                        ...
                        <form method="post" action="#" id="contact-form" class="default-form">
                            <div class="row clearfix">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                    <input type="text" name="biller" placeholder="BSES Rajdhani" readonly>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                    <input type="text" name="ID" placeholder="1423556698" readonly>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                    <input type="text" name="amount" placeholder="Rs 1425.50">
                                </div>
