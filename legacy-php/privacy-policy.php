...
<?php require_once 'header-bottom.php'; ?>
        ...
        <section class="video-section pt-50 pb-40">
            <div class="container">
				...
				<p>V.VANG SOLUTIONS PRIVATE LIMITED (“<b>PayVang</b>”, “<b>we</b>”, “<b>us</b>”, “<b>our</b>”) respects every individual’s right to privacy and it is our endeavour to protect their personal and Sensitive personal data or information (defined below).</p>
 
				<p>This Privacy Policy (“<b>Policy</b>”) applies to all visitors (i.e. those who do not have an Account with PayVang) and users (i.e. those who have an Account with PayVang) (collectively referred to as “<b>User</b>”) who share their personal and Sensitive personal data with us, while visiting, accessing, browsing and using our website <a href="https://www.payvangservices.com/" target="_blank">https://www.payvangservices.com/</a> (the “<b>Website</b>”). The purpose of this Policy is to inform Users regarding collection, use, storage, transfer and disclosure of their data. Before submitting any information to us, please carefully read this Policy to understand how we shall treat your information.</p>
				 
				<p>The User acknowledges that this Policy is a part of PayVang’s <b>Terms & Conditions</b> and all the terms defined therein shall have the same meaning here in this Policy. Access, browsing and continuous use of the Website constitutes the User’s unconditional consent to this Policy read together with the Terms of Use. If the User does not agree with the terms of this Policy, please do not visit and use our Website. This Policy can be easily accessed at various places on our Website, including but not limited to when Users create an account with us on our Website.</p>
				 
				<p>PayVang reserves its right to modify, alter, and update this Policy at any time, with or without prior notice. Although, Users shall be notified of material changes through their registered email address or any other mode of communication available with us, it is advised that they consult this Policy regularly to be updated about the changes. If a User continues to use or avail the services of the Website after any modification, amendment, alteration or change of this Policy, irrespective of whether notice was sent to the User or published on the Website, such User is hereby deemed to provide consent to this Policy and PayVang’s other Policies and practices existing at the time of visiting, accessing and/or using the Website.</p>
				 
				<p>This Policy is published in compliance of:
				i) Section 43A of the Information Technology Act, 2000 (“<b>Act</b>”)
				ii) Regulation 4 of the Information Technology (Reasonable Security Practices
				and Procedures and Sensitive Personal Information) Rules, 2011 (“<b>SPI Rules</b>”)
				</p>
				
				<p><b><u>DEFINITIONS</u></b><br/><br/>
				<b>1.PERSONAL INFORMATION</b><br/>
				...
				<b>2. SENSITIVE PERSONAL DATA OR INFORMATION</b><br/>
				SPI Rules define “Sensitive personal data or information” of a person as personal information which consists of information relating to:
								 i) passwords;<br/>
								 ii) financial information such as bank accounts or credit card or debit card or other payment instrument details;<br/>
								 iii) physical, physiological and mental health condition;<br/>
								 iv) sexual orientation;<br/>
								  v) medical records and history;<br/>
								 vi) biometric information;<br/>
								 vii) any of the information received under above clauses by body corporate for processing or storage under lawful contract or otherwise.
				...
				<p><b><u>CONSENT FOR COLLECTION OF PERSONAL INFORMATION</u></b><br/>
				...
				<p>PayVang presumes adequate and lawful parental consent in case the Personal Information or Sensitive personal data or information is shared by a User under the age of 18 years.</p>
				 
				<p><b><u>TYPES OF INFORMATION WE COLLECT</u></b><br/>
				...
				i) full name and age;<br/>
				ii) username and password;<br/>
				iii) PAN;<br/>
				iv) password of User’s account registered with us;<br/>
				v) postal address;<br/>
				vi) E-mail address;<br/>
				vii) mobile number;<br/>
				viii) internet protocol (IP) addresses (through cookies);<br/>
				ix) URL of website accessed prior to and post Users’ accessing our Website;<br/>
				x) credit/debit card number, credit/debit card expiration date and/or other payment instrument details;<br/>
				xi) User’s feedback, queries, e-mails, letters, suggestions provided to us;<br/>
				xii) third party information about concerned User’s activities or postings on the Website;<br/>
				xiii) Information about the mobile/tab device the App is installed on or mobile device identifier.<br/>
				xiv) any other information relevant for accessing and using our Website as maybe required by us.<br/>
				 </p>
				 
				<p><b>PURPOSE OF COLLECTION</b><br/>
				...
				i) to give the User a safe, efficient, smooth and personalised experience while using our Website;<br/>
				ii) to improve our services and products;<br/>
				iii) to respond to your queries or complaints generally related to our services, etc;<br/>
				iv) to send promotional emails containing information about our existing and new products/services, newsletters, notify changes in this Policy or other policies etc;<br/>
				v) to analyse the traffic on our Website and conduct market research regarding users’ demographics, interests, and behaviour;<br/>
				vi) to create new products and services;<br/>
				vii) to provide customer support services;<br/>
				viii) to detect, prevent and address error, fraud, criminal activity, abuse of our services and technical issues;<br/>
				ix) to enforce Terms of Conditions;<br/>
				x) to provide co-branded services in affiliation with more than one corporate entity;<br/>
				xi) other such lawful purposes as described at the time of collection of Personal Information or Sensitive personal data or information.<br/>
				 </p>
				 
				<p><b><u>HOW INFORMATION IS COLLECTED</u></b><br/>
				...
				<p><b><u>LINKS TO OTHER WEBSITES</u></b><br/>
				The Website may provide links to other websites which may or may not collect information about the User. The User acknowledges that this Policy does not cover the collection and use of information by such sites and that we shall not be responsible for the privacy policies, practices or content of the linked websites.
				</p>
				
				<p><b><u>CORRECTION AND UPDATION OF INFORMATION</u></b><br/>
				...
				<p><b><u>RETENTION OF INFORMATION</u></b><br/>
				...
				<p><b><u>MAILERS</u></b><br/>
				PayVang may send direct mailers to the User at the email address given by the User. The User has the option to opt-out of this direct mailer by way of links provided at the bottom of each mailer or any other means as PayVang deems appropriate. PayVang respects every User’s privacy and in the event that User chooses to not receive such mailers, PayVang will take all steps to remove the User from the list. If a User wants to remove his/her/it’s contact information from all mailing lists and newsletters, the same can be done through “Profile” page of his/her/it’s account with PayVang.
				</p>
				
				<p><b><u>ADVERTISING</u></b><br/>
				...
				<p>If you seek any clarifications regarding this Policy or wish to raise any issue or grievance with respect to illegal access, use or disclosure of Personal Information, please e-mail at info@payvang.com. Additionally, You can also write us at: <b>V.VANG SOLUTIONS PRIVATE LIMITED. 2/121, Main New Rohtak Road Karol Bagh, New Delhi-110005 </b> We may ask you to verify your identity and to provide other details to help us to respond to your request. We shall attempt to resolve any issues within a period of thirty (30) days from the date of receipt of the question, concern, grievance or report.</p>
